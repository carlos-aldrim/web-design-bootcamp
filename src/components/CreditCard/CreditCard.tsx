    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          ...
          <div className={`${styles.row} ${styles.cardExpire}`}>
            <div className={`${styles.row} ${styles.cardExpireMonth}`}>
              <label className={styles.label}>Month</label>
              <input className={styles.input} type="text" placeholder="April" />
            </div>
            <div className={`${styles.row} ${styles.cardExpireYear}`}>
              <label className={styles.label}>Year</label>
              <input className={styles.input} type="text" placeholder="2022" />
            </div>
          </div>
          <div className={`${styles.row} ${styles.cardCvv}`}>
            <label className={styles.label}>CVV</label>
            <input className={styles.input} type="text" placeholder="248" />
          </div>
        </div>
      </div>
    </div>
